...
contract('Decentragram', ([deployer, author, tipper]) => {
  ...
  describe('images', async () => {
    ...
    it('creates images', async () => {
      ...
      assert.equal(event.tipAmount.toString(), '0', 'tip is correct');
      assert.equal(event.author, author, 'author is correct');

      // Failure
      await decentragram.uploadImage('', description, { from: author }).should.be.rejected;
      await decentragram.uploadImage('new hash', '', { from: author }).should.be.rejected;
    })
    ...
    it('list images', async () => {
      ...
      assert.equal(image.tipAmount.toString(), '0', 'tip is correct');
